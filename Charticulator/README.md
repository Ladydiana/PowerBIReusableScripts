...
- [Design Examples](#design-examples)
    ...
    + [Divergent Bar Chart](#divergent-bar-chart)
    + [Dot Plot](#dot-plot)
    + [Dumbbell Chart](#dumbbell-chart)
    + [Lollipop Chart](#lollipop-chart)
    + [Nightingale Chart](#nightingale-chart)
    + [Peacock Chart](#peacock-chart)
    + [Pictogram](#pictogram)
    + [Scatterplot](#scatterplot)
    + [Spiral Bar Chart](#spiral-bar-chart)
    + [Waffle Chart](#waffle-chart)
    + [Weather Radial Chart](#weather-radial-chart)

---------------------------------------------

# AppSource
Link: https://appsource.microsoft.com/en-us/product/power-bi-visuals/wa200002793?tab=overview
